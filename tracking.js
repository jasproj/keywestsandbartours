...
(function () {
    /* HOSTNAME GUARD — booking_click is emitted from the live domain only.
       ...
       runs, not users. On the property this site shares with walktheplankadventures, 16 booking_click events came from localhost.
       ...
       because this repo emits booking_click from 4 call site(s) across
       3 file(s). Guarding only this file would leave the other emitters
    ...
    var BOOKING_CLICK_ALLOWED_HOSTS = ['keywestsandbartours.com', 'www.keywestsandbartours.com'];
